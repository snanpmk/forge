...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen h-[100dvh] bg-transparent text-gray-900 overflow-hidden font-sans">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        {/* Mobile Header (Fixed) */}
        <div className="lg:hidden p-4 flex items-center justify-between gap-4 z-40 fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md border-b border-white/20 h-[72px]">
        ...
        {/* Content - Added top padding for mobile header */}
        <div className="flex-1 overflow-y-auto p-4 lg:p-8 pt-[88px] lg:pt-8 custom-scrollbar">
